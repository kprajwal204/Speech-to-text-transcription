...
splash_image = Image.open(r"C:\Users\kpraj\Downloads\6th sem folders\mini project\splash.jpg")
...
def on_select():
    ...
    if language in ["Hindi", "Kannada", "Tamil", "Bengali", "Marathi","Telugu"]:
        progress.start()
...
tooltip_button = ToolTip(button, "Start speech recognition")
button.bind("<Enter>", lambda e: tooltip_button.show_tooltip())
button.bind("<Leave>", lambda e: tooltip_button.hide_tooltip())

tooltip_save_button = ToolTip(save_button, "Save the transcription to a file")
save_button.bind("<Enter>", lambda e: tooltip_save_button.show_tooltip())
save_button.bind("<Leave>", lambda e: tooltip_save_button.hide_tooltip())

tooltip_clear_button = ToolTip(clear_button, "Clear the text")
clear_button.bind("<Enter>", lambda e: tooltip_clear_button.show_tooltip())
clear_button.bind("<Leave>", lambda e: tooltip_clear_button.hide_tooltip())
